    ...
    <>
      ...
      <ChakraProvider>
        <Box position="fixed" zIndex="9999" width="100%" top="0">
          <Alert status="info" alignItems="center" justifyContent="center" textAlign="center" variant="solid">
            <AlertIcon />
            <AlertTitle>This tool is free to use!</AlertTitle>
            <AlertDescription>
              Consider showing some love to the developer:{' '}
              <Link href="https://paypal.me/tusinean" color="blue" isExternal>
                PayPal
              </Link>
            </AlertDescription>
          </Alert>
